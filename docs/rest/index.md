...
| POST        | `albums/{album_id}/commands`                         | `?action={flag\|rate\|share\|update_art\|update_from_tags}&filter={album_id}&type=album`   |                    |
...
| POST        | `artists/{artist_id}/commands`                       | `?action={flag\|rate\|share\|update_art\|update_from_tags}&filter={artist_id}&type=artist` |                    |
...
| POST        | `catalogs/{catalog_id}/commands`                     | `?action=catalog_action&filter={catalog_id}&task={task}`                                   |                    |
...
| POST        | `localplay/commands`                                 | `?action=localplay&command={command}&filter={object_id}&type={object_type}`                |                    |
| GET         | `localplay/delete-all`                               | `?action=localplay&command=delete_all`                                                     |                    |
| GET         | `localplay/next`                                     | `?action=localplay&command=next`                                                           |                    |
| POST        | `localplay/pause`                                    | `?action=localplay&command=pause`                                                          |                    |
| GET         | `localplay/play`                                     | `?action=localplay&command=play`                                                           |                    |
| GET         | `localplay/prev`                                     | `?action=localplay&command=prev`                                                           |                    |
| GET         | `localplay/skip`                                     | `?action=localplay&command=skip`                                                           |                    |
| GET         | `localplay/status`                                   | `?action=localplay&command=status`                                                         |                    |
| POST        | `localplay/stop`                                     | `?action=localplay&command=stop`                                                           |                    |
| GET         | `localplay/volume-down`                              | `?action=localplay&command=volume_down`                                                    |                    |
| GET         | `localplay/volume-mute`                              | `?action=localplay&command=volume_mute`                                                    |                    |
| GET         | `localplay/volume-up`                                | `?action=localplay&command=volume_up`                                                      |                    |
...
| POST        | `playlists/{playlist_id}/commands`                   | `?action={playlist_add\|playlist_remove\|playlist_remove_song}&filter={playlist_id}`       |                    |
...
| POST        | `podcast-episodes/{id}/commands`                     | `?action={flag\|rate\|share\|player\|localplay}&filter={id}&type=podcast_episode`          |                    |
...
| POST        | `podcasts/{podcast_id}/commands`                     | `?action={flag\|rate\|share\|podcast_update}&filter={podcast_id}`                          |                    |
...
| POST        | `songs/{song_id}/commands`                           | `?action={flag\|rate\|share\|player\|record_play\|localplay}&filter={song_id}`             |                    |
...
| POST        | `users/{user_id}/commands`                           | `?action=toggle_follow&filter={user_id}`                                                   |                    |
...
| POST        | `videos/{video_id}/commands`                         | `?action={flag\|rate\|share\|player\|localplay}&filter={video_id}&type=video`              |                    |
