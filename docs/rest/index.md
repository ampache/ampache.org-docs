...
| GET         | `podcast-episodes/{episode_id}/bookmark`             | `?action=bookmark_create&filter={episode_id}&type=podcast_episode`               |                    |
...
| GET         | `songs/{song_id}/bookmark`                           | `?action=bookmark_create&filter={song_id}&type=song`                             |                    |
...
| GET         | `videos/{video_id}/bookmark`                         | `?action=bookmark_create&filter={video_id}&type=video`                           |                    |
