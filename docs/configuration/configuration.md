...
As a user you can change anything that you have permission to change (see [Managing Server Preferences](https://github.com/ampache/ampache/wiki/Basic/_edit#managing-server-preferences) below)
...
Check out the [plugins](https://github.com/ampache/ampache/wiki/ampache-plugins) page for details about all our current plugins and options.
