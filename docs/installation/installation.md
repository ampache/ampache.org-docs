...
Release tarballs are available [here](https://github.com/ampache/ampache/tags). Depending on the feature and how recently it's changed, support might only be available for git HEAD.
...
After you follow the web installation make sure you check out the [Basic Configuration](https://github.com/ampache/ampache/wiki/Basic#basic-configuration) for some tips on editing you config file
...
Make sure you check out [Basic Configuration](https://github.com/ampache/ampache/wiki/Basic) before you dive in!