...
Upgrading an Ampache release version is a "drop-in" replacement for an older version. (Unless you're upgrading from [Ampache4 -> Ampache5](https://github.com/ampache/ampache/wiki/Ampache-next-Changes))
...
Did you use [git](https://github.com/ampache/ampache/wiki/Installation#download)?
...
Ampache5 has changes the website path so check out the [wiki](https://github.com/ampache/ampache/wiki/Installation#emplacement) for information about how it's been moved into the project public folder.
