...
**TODO (image):** terminal screenshot of `php bin/cli` with no arguments, showing the grouped command list.
...
**TODO (image):** terminal screenshot of `php bin/cli admin:listModules` output showing the Plugins, Catalog Types and Localplay Controllers sections with their installed state.
...
**TODO (image):** terminal screenshot of `php bin/cli show:debug` output showing the System and Environment sections.
