...
* [Installing Ampache](/docs/installation) — the general guide, with Apache, nginx, lighttpd and Caddy examples
* [Ubuntu 26.04 LTS](/docs/installation/install-ampache-on-ubuntu2604) and [Ubuntu 22.04](/docs/installation/install-ampache-on-ubuntu2204)
* [Windows](/docs/installation/windows-installation-guide)
* [Docker](/docker)

Written a guide of your own? [Open an issue](https://github.com/ampache/ampache.org-docs/issues) and it can go on this page.
